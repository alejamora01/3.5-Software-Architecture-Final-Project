...
public class NNTPClient extends NNTP
{
    ...
    private boolean executeSelectionCommand(int result, ArticleInfo pointer)
throws IOException
{
...
{
    if (articleId != null) {
        return executeSelectionCommand(stat(articleId), pointer);
    }

    return executeSelectionCommand(stat(), pointer);
}
...
throws IOException
{
    return executeSelectionCommand(stat(articleNumber), pointer);
}
...
throws IOException
{
    return executeSelectionCommand(last(), pointer);
}
...
{
    return executeSelectionCommand(next(), pointer);
}
